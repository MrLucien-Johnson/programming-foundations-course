        ...
        "slides": [
            {
                ...
                "vo": "Today’s lesson goal: make decisions with if, elif, and else. Compare values and combine conditions. Repeat work with for and while loops.",
            },
            {
            ...
            },
            {
                ...
                "vo": "Worked example: a discount. If spend is over one hundred, apply ten percent. Elif spend is over fifty, apply five percent. Otherwise no discount — print the final total.",
            },
            {
                ...
                "vo": "Loops: use for to walk through a known collection. Use while to keep going until a condition changes. Avoid infinite loops — always update the condition.",
            },
            {
                ...
                "vo": "Common mistakes: using a single equals instead of double equals in comparisons. Forgetting indentation under if or for. While true with no break or stop condition.",
            },
            {
        ...
        "slides": [
            {
                ...
                "vo": "Today’s lesson goal: pack steps into named functions. Pass inputs with parameters. Return results you can reuse.",
            },
            {
            ...
            },
            {
                ...
                "vo": "Worked example: define greet with a name parameter. Return a friendly string. Call it with different names. Reuse one function instead of copying print lines.",
            },
            {
                ...
                "vo": "Scope in plain words: names inside a function are local by default. Pass what you need in. Return what you need out. Avoid relying on hidden global variables.",
            },
            {
                "title": "Common mistakes",
                "bullets": [
                ...
                "vo": "Common mistakes: forgetting parentheses when calling. Forgetting return and wondering why you get None. Functions that try to do five unrelated jobs.",
            },
            {
                "title": "Practice checkpoint",
                "bullets": [
        ...
        "slides": [
            {
                ...
                "vo": "Today’s lesson goal: store many values in lists. Look up data with dictionaries. Choose the right collection for the job.",
            },
            {
                ...
                "vo": "Lists are ordered collections. Keep items in order and access by index. Append, remove, and loop through items. Great for playlists, baskets, and queues.",
            },
            {
            ...
            },
            {
                ...
                "vo": "Worked example: keep a list of friend names and a dictionary of name to phone number. Loop the list and print each number from the dictionary.",
            },
            {
                "title": "Common mistakes",
                "bullets": [
                ...
                "vo": "Common mistakes: off-by-one index errors. Assuming a key exists without checking — use get or check first. Mixing up list order with dictionary keys.",
            },
            {
                "title": "Practice checkpoint",
                "bullets": [
        ...
        "slides": [
            {
                ...
                "vo": "Today’s lesson goal: model real things with classes. Create objects with their own data. Call methods that use that data.",
            },
            {
            ...
            },
            {
                ...
                "vo": "Worked example: a Task class with a title and done flag. A mark done method flips the flag. Create two tasks and mark one complete.",
            },
            {
                "title": "Common mistakes",
                "bullets": [
                ...
                "vo": "Common mistakes: forgetting self in method definitions. Calling methods incorrectly on the class instead of an instance. Putting all logic in one giant class.",
            },
            {
                "title": "Practice checkpoint",
                "bullets": [
        ...
        "slides": [
            {
                ...
                "vo": "Today’s lesson goal: build a small Task Tracker end to end. Combine variables, decisions, loops, and functions. Ship something you can show on a portfolio.",
            },
            {
                ...
                "vo": "Design before you code. List features like add, list, complete, and quit. Decide how tasks are stored. Sketch the menu loop on paper first.",
            },
            {
            ...
            },
            {
                ...
                "vo": "Make it robust. Handle empty input and bad menu choices. Confirm before deleting if you add delete. Keep messages clear for beginners testing your app.",
            },
            {
                "title": "Common mistakes",
                "bullets": [
                ...
                "vo": "Common mistakes: building every feature before the menu works. No way to quit the loop. Mixing storage format so list and complete disagree.",
            },
            {
                "title": "Practice checkpoint",
                "bullets": [
                ...
                "vo": "Practice checkpoint: get add and list working first. Then add complete and quit. Then continue in the written Module 7 project and acceptance checks.",
            },
        ],
    },
    {
        ...
        "slides": [
            {
                ...
                "vo": "Today’s lesson goal: use if, else if, and else in C sharp. Compare values safely. Repeat work with for and while.",
            },
            {
                ...
                "vo": "Decisions in C sharp: conditions go in parentheses. Blocks use curly braces. Else if chains handle multiple cases.",
            },
            {
                ...
                "vo": "Worked example: ticket price. Choose child, adult, or senior based on age. Print the matching price. Otherwise ask for a valid age.",
            },
            {
                "title": "Loops in C#",
                "bullets": [
                ...
                "vo": "Loops in C sharp: for when you know the count. While when you wait for a condition. Foreach when you walk a collection.",
            },
            {
                "title": "Common mistakes",
                "bullets": [
                ...
                "vo": "Common mistakes: using a single equals instead of double equals. Missing braces so only one line is conditional. Off-by-one errors in for loops.",
            },
            {
                "title": "Practice checkpoint",
                "bullets": [
        ...
        "slides": [
            {
                ...
                "vo": "Today’s lesson goal: write methods that do one clear job. Pass arguments and return values. Keep Main short by calling helpers.",
            },
            {
            ...
            },
            {
                ...
                "vo": "Worked example: a Total method that takes price and quantity. Return price times quantity. Print the result from Main.",
            },
            {
                "title": "Common mistakes",
                "bullets": [
                ...
                "vo": "Common mistakes: wrong return type for the value you send back. Forgetting return in non-void methods. Huge methods that mix input, math, and printing.",
            },
            {
                "title": "Practice checkpoint",
                "bullets": [
        ...
        "slides": [
            {
                ...
                "vo": "Today’s lesson goal: use lists for ordered items. Use dictionaries for key lookups. Loop collections with foreach.",
            },
            {
            ...
            },
            {
                ...
                "vo": "Worked example: a list of player names and a dictionary of name to score. Foreach name, print the score.",
            },
            {
                "title": "Common mistakes",
                "bullets": [
                ...
                "vo": "Common mistakes: using arrays when a List is easier to grow. KeyNotFound when a key is missing. Mutating a collection while foreach runs.",
            },
            {
                "title": "Practice checkpoint",
                "bullets": [
        ...
        "slides": [
            {
                ...
                "vo": "Today’s lesson goal: create a simple class in C sharp. Add properties and a method. Construct objects and use them.",
            },
            {
            ...
            },
            {
                ...
                "vo": "Worked example: a Book with Title and IsRead properties. A MarkRead method. Create two books and mark one read.",
            },
            {
                "title": "Practice checkpoint",
                "bullets": [
        ...
        "slides": [
            {
                ...
                "vo": "Today’s lesson goal: assemble a console Task Tracker. Use methods and a list of tasks. Deliver a portfolio-ready mini app.",
            },
            {
            ...
            },
            {
                ...
                "vo": "Robust behaviour: validate menu choices. Ignore empty task titles. Show friendly messages for bad input.",
            },
            {
                "title": "Practice checkpoint",
                "bullets": [
                ...
                "vo": "Practice checkpoint: ship a working add and list flow today. Complete the written project checks. Save a short README of how to run it. Then continue in the written lesson.",
            },
        ],
    },
    {
        ...
        "slides": [
            {
                ...
                "vo": "Today’s lesson goal: reuse proven prompt patterns. Extract structured fields reliably. Add a review pass that does not invent facts.",
            },
            {
                ...
                "vo": "Checklist pattern: list required fields explicitly. Say what to do when data is missing. Reject guesses that are not in the source.",
            },
            {
                ...
                "vo": "Decompose then verify: break the job into clear steps. Keep drafting separate from checking. Verify structure before you trust content.",
            },
            {
                ...
                "vo": "Worked example: extract name, account, issue, and urgency as J S O N from an email. Only use the email text. A repair pass fixes invalid J S O N without adding new facts.",
            },
            {
                "title": "Practice checkpoint",
                "bullets": [
        ...
        "slides": [
            {
                ...
                "vo": "Today’s lesson goal: build a small evaluation set. Score outputs the same way each time. Iterate with evidence, not vibes.",
            },
            {
                ...
                "vo": "Good evaluation uses ten or more cases — good, bad, and ambiguous. Use a fixed rubric for format, accuracy, and safety. Rerun the same set after each prompt change.",
            },
            {
                ...
                "vo": "Worked example cases: empty input should refuse politely. A clear ticket should extract fields. Conflicting dates should ask, not invent.",
            },
            {
                "title": "Practice checkpoint",
                "bullets": [
        ...
        "slides": [
            {
                ...
                "vo": "Today’s lesson goal: spot risky prompts and outputs. Add clear refusal and escalation rules. Keep user data out of places it should not go.",
            },
            {
                ...
                "vo": "Practical safety habits: do not paste secrets into prompts. Refuse harmful or disallowed requests. Document what the system must never do.",
            },
            {
                ...
                "vo": "Worked example: a support bot may summarise tickets from provided text. It must not invent refunds or legal advice. It must escalate threats to a human.",
            },
            {
                "title": "Practice checkpoint",
                "bullets": [
        ...
        "slides": [
            {
                ...
                "vo": "Today’s lesson goal: chain steps into a simple workflow. Keep humans in the loop where it matters. Log decisions so you can improve later.",
            },
            {
            ...
            },
            {
                ...
                "vo": "Worked example: draft a summary. Validate required fields. A human approves before send.",
            },
            {
                "title": "Practice checkpoint",
                "bullets": [
        ...
        "slides": [
            {
                ...
                "vo": "How these intermediate modules work. Each one builds one practical skill. Read the lesson, try the examples, then take the quiz. Keep notes of decisions and tradeoffs.",
            },
            {
                "title": "Study rhythm",
                "bullets": [
                ...
                "vo": "Use a steady study rhythm. Skim goals first. Type along with worked examples. Only then attempt Core and Better exercises.",
            },
            {
                ...
                "vo": "When you get stuck, re-read the common mistakes section. Simplify the input and retry. Open Help or return to the previous module if needed.",
            },
            {
                "title": "Next step",
                "bullets": [
                ...
                "vo": "Next step: open the written lesson for this module. Mark progress as you complete quizzes. Move on when Core exercises pass your own checks.",
            },
        ],
    },
    {
        ...
        "slides": [
            {
                ...
                "vo": "Advanced module expectations: assume beginner fundamentals are solid. Focus on design, tradeoffs, and reliability. Treat each module like a professional brief.",
            },
            {
                ...
                "vo": "How to learn effectively: restate the problem in your own words. Compare two approaches before coding. Write down failure modes you must avoid.",
            },
            {
                ...
                "vo": "Evidence of progress: complete the quiz to check understanding. Keep a short change log of what you tried. Link your notes to the module acceptance criteria.",
            },
            {
                "title": "Next step",
                "bullets": [
                ...
                "vo": "Next step: open this module’s written lesson now. Work Core exercises before Beast Mode. Ask for help early on architecture questions.",
            },
        ],
    },
]
