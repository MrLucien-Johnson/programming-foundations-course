# Swift Advanced — Module 02: Architecture Patterns Quiz Answers
...
**Answer: A** - Layered vs hexagonal vs clean architecture (45 min)
...
**Answer: A** - Copy the starter pack from `languages/swift/advanced/starter-pack` into a new working folder.
...
**Answer: C** - Apply architectural patterns to keep systems evolvable.
