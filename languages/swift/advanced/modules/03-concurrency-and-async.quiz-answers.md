# Swift Advanced — Module 03: Concurrency and Async Quiz Answers
...
**Answer: C** - Concurrency primitives + race conditions (45 min)
...
**Answer: D** - Copy the starter pack from `languages/swift/advanced/starter-pack` into a new working folder.
...
**Answer: A** - Build correct concurrent systems and manage backpressure.
