# Swift Advanced — Module 01: System Design Foundations Quiz Answers
...
**Answer: A** - Requirements → constraints → estimates (45 min)
...
**Answer: C** - Copy the starter pack from `languages/swift/advanced/starter-pack` into a new working folder.
