...
- **Environment**: Swift 5.10+ (SwiftPM)
- **Build/Packages**: Swift Package Manager (swift build)
- **Testing**: XCTest (swift test)
- **Lint/Format**: SwiftFormat + SwiftLint
- **Web/API**: Vapor (server-side Swift) for REST APIs
- **Database**: PostgreSQL + migrations (Fluent)
- **Containers**: Docker + docker-compose for Postgres
