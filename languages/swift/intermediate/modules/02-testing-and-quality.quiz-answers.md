# Swift Intermediate — Module 02: Testing and Quality Quiz Answers
...
## Question 11: In this course's Swift tooling, which command runs the test suite?
**Answer: A** — `swift test`

**Outcome 5:** Use lint, format, and typecheck as automated quality gates.

**Explanation:** `swift test` runs XCTest via SwiftPM.
