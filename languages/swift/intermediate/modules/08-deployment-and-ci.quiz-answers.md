# Swift Intermediate — Module 08: Deployment and CI Quiz Answers
...
**Answer: A** - Explain the core concepts and tradeoffs for **Deployment and CI**.
...
**Answer: A** - Environments + configuration (35 min)
...
**Answer: B** - Copy the starter pack from `languages/swift/intermediate/starter-pack` into a new working folder.
