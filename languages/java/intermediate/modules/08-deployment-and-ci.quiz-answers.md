# Java Intermediate — Module 08: Deployment and CI Quiz Answers
...
**Answer: C** - Environments + configuration (35 min)
...
**Answer: C** - Containerize, configure, and deploy with automated CI checks.
