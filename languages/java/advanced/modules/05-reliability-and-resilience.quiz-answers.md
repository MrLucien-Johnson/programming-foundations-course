# Java Advanced — Module 05: Reliability and Resilience Quiz Answers
...
**Answer: B** - Explain the core concepts and tradeoffs for **Reliability and Resilience**.
...
**Answer: B** - Retries, timeouts, budgets, and jitter (45 min)
...
**Answer: D** - Copy the starter pack from `languages/java/advanced/starter-pack` into a new working folder.
...
**Answer: A** - Design for failure using resilient patterns and operational readiness.
