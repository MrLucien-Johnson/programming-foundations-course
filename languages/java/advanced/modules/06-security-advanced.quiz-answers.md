# Java Advanced — Module 06: Security (Advanced) Quiz Answers
...
**Answer: D** - Threat modeling + abuse cases (45 min)
...
**Answer: B** - Threat-model, harden, and protect secrets, data, and supply chain.
