...
- [Practical AI Workflows](guide-viewer.html?path=guides/practical-ai.md) — everyday automation patterns
- [Prompting Guide](guide-viewer.html?path=guides/prompting-guide.md) — reliable prompt structure
