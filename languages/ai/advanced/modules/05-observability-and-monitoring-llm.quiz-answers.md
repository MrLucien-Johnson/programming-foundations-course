...
**Answer: A** - Design a dashboard layout and alert thresholds.
...
**Answer: B** - Includes quality, safety, cost, and latency signals.
...
**Answer: A** - Design tracing across steps (retrieval, generation, tools).
