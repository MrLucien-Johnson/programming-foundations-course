...
**Answer: B** - Includes tool security, data security, and injection defenses.
...
**Answer: C** - Add data minimization and retention rules to the design.
...
**Answer: C** - Add a supply-chain policy for prompt/eval artifacts.
...
**Answer: D** - Design a red-team suite that targets top threats.
