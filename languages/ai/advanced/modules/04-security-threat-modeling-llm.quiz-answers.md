...
**Answer: D** - Threat modeling workflow: assets, attackers, entry points (50 min)
...
**Answer: A** - Add a least-privilege tool policy and verify via tests.
...
**Answer: B** - Design incident response for security events (triage + containment).
...
**Answer: C** - Treating retrieved content as trusted instructions.
...
**Answer: D** - Threat model LLM applications: injection, data exfiltration, tool abuse, and supply chain risks.
