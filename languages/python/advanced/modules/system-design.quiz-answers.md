...
**Answer: D** - Copy the starter pack from `languages/python/advanced/starter-pack` into a new working folder.
...
**Answer: B** - Verify the primary feature works with normal and edge-case inputs.
