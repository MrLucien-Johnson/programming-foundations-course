# SQL (PostgreSQL) Advanced — Module 03: Concurrency and Async

## Overview
Build correct concurrent systems and manage backpressure.
...
## Lessons
1) Concurrency primitives + race conditions (45 min)
2) Backpressure + bounded work queues (45 min)
...
## Mini-Project
### Brief
Build a small, production-leaning feature or service slice that showcases **Concurrency and Async** in a way you could explain in a code review.
