# SQL (PostgreSQL) Advanced — Module 02: Architecture Patterns

## Overview
Apply architectural patterns to keep systems evolvable.
...
## Lessons
1) Layered vs hexagonal vs clean architecture (45 min)
2) DDD building blocks: entities, value objects, aggregates (45 min)
3) Event-driven design + sagas (45 min)
4) CQRS and when *not* to use it (35 min)
...
2. Review the module goals and plan how you will choose and apply architecture patterns.
3. Compare two patterns and choose one for the module scenario.
4. Document tradeoffs and why you chose it.
5. Implement the pattern in a small feature slice.
...
## Mini-Project
### Brief
Build a small, production-leaning feature or service slice that showcases **Architecture Patterns** in a way you could explain in a code review.
