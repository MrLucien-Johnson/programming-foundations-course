# SQL (PostgreSQL) Advanced — Module 04: Performance and Profiling Quiz Answers
...
**Answer: A** - Explain the core concepts and tradeoffs for **Performance and Profiling**.
...
**Answer: B** - Profiling methodology and baselines (40 min)
...
**Answer: D** - Copy the starter pack from `languages/sql/advanced/starter-pack` into a new working folder.
...
**Answer: C** - Profile, measure, and optimize across app + database + network.
