...
**Answer: B** - Explain the core concepts and tradeoffs for **Testing and Quality**.
...
**Answer: A** - Test pyramid and what to mock (40 min)
...
**Answer: B** - Copy the starter pack from `languages/sql/intermediate/starter-pack` into a new working folder.
