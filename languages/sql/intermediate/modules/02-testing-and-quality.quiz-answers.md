...
**Answer: A** — Run migration + query validation / pgTAP (or equivalent) in CI

**Outcome 5:** Use lint, format, and typecheck as automated quality gates.

**Explanation:** SQL tracks rely on migration/query validation (and often pgTAP/sqlfluff) as gates.
