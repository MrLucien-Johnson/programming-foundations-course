# Rust Intermediate — Mini Project 2: Auth + Roles Upgrade

## Overview
- **Goal**: Add authentication and authorization to an existing API, plus a few protected routes.
- **Expected effort**: 1–2 days

## Brief
Build the deliverable using idiomatic tools for **Rust**:
- Cargo
- cargo test
- axum (or actix-web) REST + tokio
- PostgreSQL + migrations (sqlx migrate) + SQLx
...
- cargo test; docker compose up -d; cargo run
