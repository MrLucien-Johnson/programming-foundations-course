# Rust Intermediate — Module 07: Debugging and Performance
...
1. Copy the starter pack from `languages/rust/intermediate/starter-pack` into a new working folder.
...
Use the starter pack in `languages/rust/intermediate/starter-pack` for a clean baseline.
