...
**Answer: A** - Explain the core concepts and tradeoffs for **System Design Foundations**.
...
**Answer: B** - Requirements → constraints → estimates (60 min)
...
**Answer: C** - Reason about scalability, data, and tradeoffs under constraints.
