# TypeScript Advanced — Module 02: Architecture Patterns Quiz Answers
...
**Answer: B** - Layered vs hexagonal vs clean architecture (55 min)
...
**Answer: C** - Copy the starter pack from `languages/typescript/advanced/starter-pack` into a new working folder.
...
**Answer: D** - Apply architectural patterns to keep systems evolvable.
