# TypeScript Advanced — Module 06: Security (Advanced)
...
## Lessons
1) Threat modeling + abuse cases (55 min)
2) Encryption at rest/in transit + key management (55 min)
3) Supply-chain security + dependency policies (45 min)
4) Security testing and hardening checklist (50 min)
