# TypeScript Advanced — Module 02: Architecture Patterns
...
## Lessons
1) Layered vs hexagonal vs clean architecture (55 min)
2) DDD building blocks: entities, value objects, aggregates (60 min)
3) Event-driven design + sagas (60 min)
4) CQRS and when *not* to use it (45 min)
