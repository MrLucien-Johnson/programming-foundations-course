# TypeScript Advanced — Module 03: Concurrency and Async
...
## Lessons
1) Concurrency primitives + race conditions (60 min)
2) Backpressure + bounded work queues (55 min)
3) Timeouts, cancellation, and structured concurrency (55 min)
4) Idempotency + exactly-once myths (45 min)
