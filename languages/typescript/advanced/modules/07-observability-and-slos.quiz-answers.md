...
**Answer: B** - Explain the core concepts and tradeoffs for **Observability and SLOs**.
...
**Answer: C** - SLIs/SLOs and error budgets (55 min)
...
**Answer: D** - Instrument systems and run them with SLO-based operations.
