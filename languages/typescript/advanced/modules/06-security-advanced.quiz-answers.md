...
**Answer: D** - Explain the core concepts and tradeoffs for **Security (Advanced)**.
...
**Answer: B** - Threat modeling + abuse cases (55 min)
...
**Answer: A** - Threat-model, harden, and protect secrets, data, and supply chain.
