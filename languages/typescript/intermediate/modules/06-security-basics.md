# TypeScript Intermediate — Module 06: Security Basics
...
## Lessons
1) OWASP Top 10: practical mapping (50 min)
2) Secrets + config management (45 min)
3) Injection + validation + encoding (55 min)
4) AuthZ checks + least privilege (45 min)
