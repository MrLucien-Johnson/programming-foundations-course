# TypeScript Intermediate — Module 05: Databases
...
## Lessons
1) Schema design + constraints (55 min)
2) Migrations: forwards/backwards + safety (55 min)
3) Transactions + isolation basics (55 min)
4) Indexes + query plans (60 min)
5) ORM/query builder pitfalls (45 min)
