# TypeScript Intermediate — Module 07: Debugging and Performance
...
## Lessons
1) Debugging workflow: reproduce → isolate → fix (45 min)
2) Logging and tracing basics (50 min)
3) Profiling CPU + memory (60 min)
4) Database performance: slow queries + indexes (55 min)
