...
**Answer: B** - Explain the core concepts and tradeoffs for **Git and Collaboration**.
...
**Answer: A** - Branching strategies + commit hygiene (50 min)
...
**Answer: A** - Collaborate safely using branching, PRs, and reviews.
