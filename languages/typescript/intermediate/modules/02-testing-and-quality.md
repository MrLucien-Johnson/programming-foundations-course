# TypeScript Intermediate — Module 02: Testing and Quality
...
## Lessons
1) Test pyramid and what to mock (50 min)
2) Unit tests: determinism, fixtures, factories (60 min)
3) Integration tests: HTTP + DB (60 min)
4) Coverage and meaningful assertions (45 min)
5) Lint/format/typecheck as quality gates (50 min)
