# TypeScript Intermediate — Module 04: APIs and Auth
...
## Lessons
1) REST: resources, status codes, pagination (60 min)
2) Input validation + error envelopes (55 min)
3) AuthN vs AuthZ: sessions/JWT + roles (60 min)
4) Rate limiting + basic abuse protections (45 min)
5) API docs: OpenAPI + examples (45 min)
