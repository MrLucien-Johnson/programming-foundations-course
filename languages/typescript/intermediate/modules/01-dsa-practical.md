# TypeScript Intermediate — Module 01: DSA (Practical)
...
## Lessons
1) Big-O and tradeoffs in real code (55 min)
2) Arrays/lists, hash maps, and sets (60 min)
3) Stacks/queues + BFS/DFS mental models (60 min)
4) Sorting/searching: when built-ins are enough (45 min)
5) Caching patterns: LRU + memoization (60 min)
6) Measuring: micro-benchmarks vs profiling (45 min)
