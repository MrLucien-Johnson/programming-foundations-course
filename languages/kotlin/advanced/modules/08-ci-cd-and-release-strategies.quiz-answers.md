...
**Answer: A** - Release strategies: canary, blue/green, rolling (45 min)
...
**Answer: B** - Copy the starter pack from `languages/kotlin/advanced/starter-pack` into a new working folder.
