# Kotlin Advanced — Module 02: Architecture Patterns
...
1. Copy the starter pack from `languages/kotlin/advanced/starter-pack` into a new working folder.
...
Use the starter pack in `languages/kotlin/advanced/starter-pack` for a clean baseline.
