# Kotlin Intermediate — Module 01: DSA (Practical) Quiz Answers
...
**Answer: A** - Big-O and tradeoffs in real code (45 min)
...
**Answer: B** - Copy the starter pack from `languages/kotlin/intermediate/starter-pack` into a new working folder.
...
**Answer: A** - Use data structures and algorithms pragmatically in real applications.
