...
**Answer: A** - Explain the core concepts and tradeoffs for **Security Basics**.
...
**Answer: D** - Copy the starter pack from `languages/kotlin/intermediate/starter-pack` into a new working folder.
...
**Answer: B** - Reduce common vulnerabilities with safe defaults.
