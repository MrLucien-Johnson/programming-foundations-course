...
## Question 11: In this course's Kotlin/Gradle tooling, which task runs unit tests?
**Answer: A** — `./gradlew test`

**Outcome 5:** Use lint, format, and typecheck as automated quality gates.

**Explanation:** Gradle's `test` task runs the JUnit suite for the project.
